            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-12 col-12 text-center">
                        <h2 class="mb-5">Guru Pengganti</h2>
                    </div>
                    <div class="col-lg-12 col-12 text-center text-justify ">
                      <h4 class="mb-5">Program guru pengganti merupakan sebuah program yang disisipkan oleh
                        Benih Cemerlang untuk membantu sekolah memvariasikan dan menambah
                        referensi belajar bagi para siswa di hari tertentu sesuai dengan jadwal serta materi
                        yang sudah ditetapkan sekolah. </h4>
                  </div>

                  <div class="col-lg-12 col-12 text-center">
                    <h2 class="mb-5"><br>Profile Guru Pengganti</h2>
                </div>

                      <div class="card-group">
                        <div class="card">
                          <img src="/img/guru/dina.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">Dina Prayani Jayanti</h5>
                            <p class="card-text">Pendidikan Guru Sekolah Dasar <br> UHN I GUSTI BAGUS SUGRIWA DENPASAR </p>
                          </div>
                        </div>
                        <div class="card">
                          <img src="/img/guru/agung.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">AA Gede Agung Krisnawan</h5>
                            <p class="card-text">Pendidikan Bahasa Inggris <br> MAHASARASWATI DENPASAR </p>
                          </div>
                        </div>
                        <div class="card">
                          <img src="/img/guru/komang.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">Komang wiliani</h5>
                            <p class="card-text">Pendidikan Bahasa Inggris <br> UNIVERSITAS PENDIDIKAN GANESHA </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card-group">
                        <div class="card">
                          <img src="/img/guru/luh.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">Luh Kade Diana Kusumadewi</h5>
                            <p class="card-text">Pendidikan Bahasa Inggris <br> UNIVERSITAS PENDIDIKAN GANESHA </p>                          </div>
                        </div>
                        <div class="card">
                          <img src="/img/guru/rista.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">Rista Hardiantini</h5>
                            <p class="card-text">Pendidikan Bahasa Inggris <br> UNIVERSITAS PENDIDIKAN GANESHA </p>                          </div>
                        </div>
                        <div class="card">
                          <img src="/img/guru/yuni.jpg" class="card-img-top" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">Yuni Hartati</h5>
                            <p class="card-text">Pendidikan Guru Sekolah Dasar <br> UHN I GUSTI BAGUS SUGRIWA DENPASAR </p>
                          </div>
                        </div>
                      </div>
