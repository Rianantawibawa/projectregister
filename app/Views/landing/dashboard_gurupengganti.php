    ...
    <main>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <?php $i = 1; foreach ($daftarguru as $guru): ?>
            <tr>
                <td><?= $i++; ?> </td>
                <td><?= $guru ->namaguru ?> </td>
                <td><?= $guru ->ttl ?> </td>
                <td><?= $guru ->hp ?> </td>
                <td><a href="<?= base_url('detail_gurupengganti').'/'.$guru ->id ?>" class="btn btn-info btn-sm">Detail</a>
                <a href="<?= base_url('delete_guru').'/'.$guru ->id ?>" class="btn btn-danger btn-sm">Delete</a></td>
