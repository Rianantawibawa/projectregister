...
<html lang="en">
    ...
    <main>
            ...
            <h1> PENDAFTARAN GURU PENGGANTI</h1><br>
                <form action="<?= base_url('proses_edit_guru') ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" class="form-control" id="id_guru" name="id_guru" value="<?= $daftarguru->id ?>" >
                <div class="mb-3">
                    <label for="nama" class="form-label">Nama</label>
                    <input type="text" class="form-control" id="namaguru" name="namaguru" value="<?= $daftarguru->namaguru ?>" required>
                </div>
                <div class="mb-3">
                    <label for="jurusan" class="form-label">alamat</label>
                    <input type="text" class="form-control" id="alamatguru" name="alamatguru" value="<?= $daftarguru->alamatguru ?>" required>
                </div>
                <div class="mb-3">
                    <label for="univ" class="form-label">Tempat Tanggal Lahir</label>
                    <input type="text" class="form-control" id="ttl" name="ttl" value="<?= $daftarguru->ttl ?>" required>
                </div>
                <div class="mb-3">
                    <label for="univ" class="form-label">No Hp</label>
                    <input type="text" class="form-control" id="hp" name="hp" value="<?= $daftarguru->hp ?>" required>
                </div>
                <div class="mb-3">
                    <label for="univ" class="form-label">Pendidikan Terakhir</label>
                    <input type="text" class="form-control" id="pendidikan" name="pendidikan"  value="<?= $daftarguru->pendidikan ?>" required>
                </div>
                <div class="mb-3">
                <label for="foto" class="form-label">Scan Ijazah</label>
                <input class="form-control" type="file" id="ijazah" name="ijazah" accept="application/pdf" value="<?= $daftarguru->ijazah ?>" required>
                </div>
                <div class="mb-3">
                <label for="foto" class="form-label">Scan Ktp</label>
                <input class="form-control" type="file" id="ktp" name="ktp" accept="application/pdf" value="<?= $daftarguru->ktp ?>" required>
                </div>
                <div class="mb-3">
                <label for="foto" class="form-label">Scan CV</label>
                <input class="form-control" type="file" id="cv" name="cv" accept="application/pdf" value="<?= $daftarguru->cv ?>" required>
                </div>
                <div class="mb-3">
                <a href="/dashboard_mitrasekolah" class="btn btn-danger">Kembali</a> 
