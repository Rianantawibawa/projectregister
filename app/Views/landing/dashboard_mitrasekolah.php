...
<html lang="en">
    ...
    <main>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <?php $i = 1; foreach ($daftarmitrasekolah as $mitrasekolah): ?>
            <tr>
                ...
                <td><a href="<?= base_url('landing/detail_mitrasekolah').'/'.$mitrasekolah ->id ?>" class="btn btn-info btn-sm">Detail</a>
                <a href="<?= base_url('delete_mitrasekolah').'/'.$mitrasekolah ->id ?>" class="btn btn-danger btn-sm">Delete</a></td>
        ...
        <footer class="site-footerdashboard">
