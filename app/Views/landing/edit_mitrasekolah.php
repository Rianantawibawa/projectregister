...
<html lang="en">
    ...
    <main>
            ...
            <div class= "container">
            <h1> Edit Pendaftaran Mitra Sekolah</h1>

                <form action="<?= base_url('proses_edit_mitrasekolah') ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" class="form-control" id="id_sekolah" name="id_sekolah" value="<?= $daftarmitrasekolah->id ?>" >
                <div class="mb-3">
                    <label for="namasekolah" class="form-label">Nama Sekolah</label>
                    <input type="text" class="form-control" id="namasekolah" name="namasekolah" value="<?= $daftarmitrasekolah->namasekolah ?>" required>
                </div>
                <div class="mb-3">
                    <label for="alamatsekolah" class="form-label">Alamat</label>
                    <input type="text" class="form-control" id="alamatsekolah" name="alamatsekolah" value="<?= $daftarmitrasekolah->alamatsekolah ?>" required>
                </div>
                <div class="mb-3">
                    <label for="tglberdiri" class="form-label">Tanggal Berdiri</label>
                    <input type="text" class="form-control" id="tglberdiri" name="tglberdiri" value="<?= $daftarmitrasekolah->tglberdiri ?>" required>
                </div>
                <div class="mb-3">
                    <label for="kepsek" class="form-label">Nama Kepala Sekolah</label>
                    <input type="text" class="form-control" id="kepsek" name="kepsek" value="<?= $daftarmitrasekolah->kepsek ?>" required>
                </div>
                <div class="mb-3">
                    <label for="operator" class="form-label">Nama Operator </label>
                    <input type="text" class="form-control" id="operator" name="operator" value="<?= $daftarmitrasekolah->operator ?>" required>
                </div>
                <div class="mb-3">
                <label for="fotosekolah" class="form-label">Foto</label>
                <input class="form-control" type="file" id="fotosekolah" name="fotosekolah" value="<?= $daftarmitrasekolah->fotosekolah ?>" required>
                </div>
                <div class="mb-3">
